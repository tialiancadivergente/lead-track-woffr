  ...
  const benefitsMapping = [
    {
      ...
      text: (
        <p className={`text-2xl md:text-xl md:uppercase capitalize text-center`}>
          Você não está ficando para trás por falta de conhecimento ou de força de vontade, <span className={`${isDark ? 'text-[#c0964b]' : 'text-bold'} font-bold`}>você está ficando para trás por falta de permissão.</span>
        </p>
      )
    },
    {
    ...
    <section id="hero" className={`relative flex flex-col items-center p-4 md:p-0 justify-center overflow-hidden bg-gradient-to-r from-[#000000] via-[#07242c] to-[#000000] z-0 ${isDark ? 'bg-gradient-to-r from-[#000000] via-[#07242c] to-[#000000]' : 'bg-gradient-to-r from-[#f4f0e1] via-[#f4f0e1] to-[#f4f0e1]'}`}>
          ...
          <div className="my-4 sm:my-8">
            {!titleRedLine ? (
              <>
                ...
                <h2 className="text-[#c0964b] text-4xl md:text-5xl font-bold mb-1">DEPENDÊNCIA</h2>
                <h2 className="text-[#c0964b] text-4xl md:text-5xl font-bold mb-2">EMOCIONAL <span className="text-[#D3CAC0] text-3xl block md:inline">gratuito</span></h2>
              </>
            ) : (
              <>
          ...
          <form onSubmit={handleSubmit} id="cadastro" name={launch} className={`space-y-4 ${isPicture ? 'max-w-lg' : 'max-w-md'} mx-auto`}>
            <div>
              <input
                ...
                className={`w-full px-4 py-3 rounded-md bg-[#f4f0e1]/90 text-[#07242c] ${!isDark ? 'border border-gray-300' : ''}`}
                value={email}
            ...
            <div className="relative">
              ...
              <div className="flex">
                <select
                  className={`py-3 pl-10 pr-2 rounded-l-md bg-[#f4f0e1]/90 text-[#07242c] border-r border-gray-300 focus:ring-0 focus:outline-none ${!isDark ? 'border border-gray-300' : ''}`}
                  value={ddi}
                ...
                <input
                  ...
                  className={`flex-1 px-4 py-3 rounded-r-md bg-[#f4f0e1]/90 text-[#07242c] focus:outline-none ${!isDark ? 'border border-gray-300' : ''}`}
                  value={whatsapp}
      ...
      <footer className="w-full mb-24 max-w-3xl mx-auto">
          ...
          <div className="text-center text-[#f4f0e1] text-xs md:text-sm font-serif tracking-wide pb-6">
            <div className={`${isDark ? 'text-[#f4f0e1]' : 'text-[#07242c]'}`}>COPYRIGHT © 2025. O RESGATE DOS OTIMISTAS.</div>
