...
export default function SplashScreenOfrr({ children }: { children: React.ReactNode }) {
    ...
    <AnimatePresence mode="wait">
      {loading ? (
        ...
        >
          ...
          />
          <div className="w-64 h-2 mt-4 bg-custom-primary-gold rounded-full overflow-hidden">
            <motion.div 
              className="h-full"
              initial={{ width: 0 }}
