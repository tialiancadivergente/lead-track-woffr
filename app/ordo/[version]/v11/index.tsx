...
export default function Formv19() {
  ...
  return (
    <div>
      ...
      >
        <div className="absolute top-0 right-0 lg:w-[1542px] sm:w-[1280px] w-[1000px] bg-no-repeat">
          <Image
            src="/images/v11/Elton-Euler-Resgate-dos-Otimistas.png"
        ...
        <div
          className={`container mx-auto px-4 lg:py-10 py-5 relative lg:w-[1080px] w-auto`}
        >
          ...
          <div className="w-full">
            ...
            <div className="lg:mt-8 mt-64 text-center lg:text-left">
              {!titleRedLine ? (
                <>
            ...
            <p className="mb-4 mt-0 flex items-center text-[#021217] text-center lg:text-left font-bold lg:text-xl text-[16px] max-w-[486px] h-[97px] bg-[url('/images/v11/bg-headline.png')] bg-cover bg-center">
              {redLine ? (
                <span>{redLine}</span>
              ) : (
                <>
            ...
            <p className="text-base lg:text-xl text-center lg:text-left max-w-[486px] text-white mb-4">
              Preencha dos dados abaixo para fazer o seu diagnóstico de bloqueio
              de permissão gratuito e destrave seu teto financeiro
              imediatamente.
            </p>
            <form
              ...
              id="cadastro"
              name={launch}
              className={`space-y-4 max-w-[486px]`}
            >
              <div>
                <input
                  type="email"
